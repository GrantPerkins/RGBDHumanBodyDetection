from versions.sae2.sparse import SparseAutoEncoder
from versions.sae2.cnn import ConvolutionalNeuralNetwork
from versions.sae2.regions import Histogram
from versions.sae2.slidingwindow import SlidingWindowLocalization
import math
