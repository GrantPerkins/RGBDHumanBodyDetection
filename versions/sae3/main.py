from versions.sae3.sparse import SparseAutoEncoder
from versions.sae3.cnn import ConvolutionalNeuralNetwork
from versions.sae3.regions import Histogram
from versions.sae3.slidingwindow import SlidingWindowLocalization
import math
